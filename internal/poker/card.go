...
func isRoyalFlush(cards []card) bool {
	// If a flush and the first and last card are "A" and "10" respectively, then it's a royal flush.
...
func isFlush(cards []card) bool {
	// If the first and last card are the same suit, then it's a flush.
	// This is due to ordering by rank and suit
