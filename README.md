...
```bash
go test -coverprofile=/tmp/poker-evaluator-go-code-cover github.com/softwarespot/poker-evaluator/internal/poker -count=1 -v
```
...
The code has been licensed under the [MIT](https://opensource.org/license/mit)
license.
